/*
  # Fix audit trigger auth.users access issue
  
  1. Changes
    - Modify log_audit_changes to handle auth.users access safely
    - Add proper error handling
    - Use SECURITY DEFINER with proper search_path
  
  2. Security
    - Function runs with definer privileges to access auth schema
    - Proper error handling prevents trigger failures
*/

-- Drop and recreate the log_audit_changes function with proper permissions
